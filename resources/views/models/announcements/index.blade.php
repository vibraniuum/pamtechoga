...
>
    <x-slot name="actions">
        <x-fab::elements.button type="link" :url="route('lego.pamtechoga.announcements.create')">Create</x-fab::elements.button>
    </x-slot>
            ...
            <x-fab::lists.table.row :odd="$loop->odd">
                @if($this->shouldShowColumn('title'))
                    <x-fab::lists.table.column primary full>
                        <a href="{{ route('lego.pamtechoga.announcements.edit', $data) }}">{{ $data->title }}</a>
                ...
                <x-fab::lists.table.column align="right" slim>
                                    <a href="{{ route('lego.pamtechoga.announcements.edit', $data) }}">Edit</a>
                </x-fab::lists.table.column>
